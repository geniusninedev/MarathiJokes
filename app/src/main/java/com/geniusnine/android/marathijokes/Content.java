...
public class Content extends AppCompatActivity {
    ...
    private MobileServiceSyncTable<MarathiJokesContent> mContent;
    private ContentAdapter Adapter;
    private RecyclerView recyclerViewContent;
    ArrayList<MarathiJokesContent> content;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mContent = mClient.getSyncTable("MarathiJokesContent", MarathiJokesContent.class);
            initLocalStore().get();
            ...
            Adapter = new ContentAdapter(this,content);
    ...
    public void showAll(final String cat) {
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    final List<MarathiJokesContent> results = mContent.read(query).get();
